...
public class IntegerPropertyEditor extends PropertyEditorSupport{
  ...
  public java.awt.Component getCustomEditor() {
	...
	public void onChange(){
      ...
      editor.add(valueField, 0, 0, 3, 1, GridBagConstraints.WEST, editor.HORIZONTAL, 1, 0);
      editor.add(Box.createHorizontalGlue(), 0, 1, 3, 1, editor.CENTER, editor.HORIZONTAL, 1d, 0);
    }
