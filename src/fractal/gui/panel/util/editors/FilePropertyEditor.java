...
public class FilePropertyEditor extends PropertyEditorSupport{
  ...
  public java.awt.Component getCustomEditor() {
    if(editor == null){
      ...
      editor.add(path, 0, 0, 3, 1, editor.CENTER, editor.NONE, 0, 0);
      editor.add(browse, 0, 1, 1, 1, editor.CENTER, editor.NONE, 0, 0);
      editor.add(Box.createHorizontalGlue(), 2, 1, 3, 1, editor.CENTER, editor.HORIZONTAL, 1, 0);
